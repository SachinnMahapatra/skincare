    ...
    <section className="w-full bg-[#FEFFF4]  py-16">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 px-4 sm:px-6">
        ...
        <div className="flex flex-col justify-center">
          ...
          <h2 className="text-[#2D3B36] text-4xl md:text-5xl font-extrabold mb-4 leading-tight">
        ...
        <div className="flex items-center justify-center relative">
          ...
          {/* Since 2001 and Learn More for tablet/desktop */}
          {/* <div className="absolute bottom-2 left-0 right-0 hidden sm:flex justify-between px-4 text-[#2D3B36] text-xs opacity-60">
            <span>SINCE 2001</span>
